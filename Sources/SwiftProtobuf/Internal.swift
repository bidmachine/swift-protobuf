...
/// Functions that are internal only because they are used by generated message
...
internal enum Internal {
  ...
  internal static func areAllInitialized<K>(_ mapToMessages: [K: Message]) -> Bool {
