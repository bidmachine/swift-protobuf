...
///
/// In general, use `BidMachineModules.Message` instead when you need a variable or
/// argument that can hold any type of message. Occasionally, you can use
/// `BidMachineModules.Message & Equatable` or `BidMachineModules.Message & Hashable` as
