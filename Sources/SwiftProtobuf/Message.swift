...
internal protocol Message: CustomDebugStringConvertible {
...
///
/// In general, use `BidMachine.Message` instead when you need a variable or
/// argument that can hold any type of message. Occasionally, you can use
/// `BidMachine.Message & Equatable` or `BidMachine.Message & Hashable` as
...
internal protocol _MessageImplementationBase: Message, Hashable {
...
extension _MessageImplementationBase {
  internal func isEqualTo(message: Message) -> Bool {
  ...
  internal func _protobuf_generated_isEqualTo(other: Self) -> Bool {
    return self == other
  }
}
